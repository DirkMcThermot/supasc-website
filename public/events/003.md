...
# Elevator Pitch
- The squad made it back to the cargo elevator they’d used at the start of the mission with the subaltern and performed more light repairs on the slow journey back to the Surface above Port Conroy.
- Suddenly, the power was cut, and CF was forced to work their way through a maintenance shaft for the rest of the return trip.
- Perhaps unsurprisingly, more of the Talons then showed up to finish what their colleagues had started, and once again put up one hell of a fight.
- Despite Scimitar’s Acastus getting destroyed, the squad pulled together once more and successfully extracted the subaltern back to Port Conroy, thus ending the mission in success. Outstanding work, lancers!